...
\item
  ...
  \item
    ...
    \item
      ...
      Desmarais. 2025. ``Public Oﬀicials' Online Sharing of
      Misinformation: Institutional and Ideological Checks.''
      \emph{Conditionally Accepted at Political Communication}.
    \end{enumerate}
  \item
    \begin{enumerate}
    \def\labelenumi{\arabic{enumi}.}
    ...
    \item
      ...
      Local Oﬀicials.'' \emph{Scientific Data}.
    \end{enumerate}
  \item
    \begin{enumerate}
    \def\labelenumi{\arabic{enumi}.}
  ...
  \item
    ...
    \item
      ...
      students}{]} \emph{Accepted at CySoc 2025 International Workshop
      on Cyber Social Threats.}
    \end{enumerate}
  \item
    \begin{enumerate}
    \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      \textbf{Tai, Yuehong Cassandra}.2025. ``Comparative Estimates of
      Public Trust in Government Across 115 Countries, 1973--2020''
...
\item
  ...
  \tightlist
  \item
    Yu, Dong Erico, and \textbf{Yuehong Cassandra Tai}. ``Speak `As Good
    As Men'? An Empirical Study of Gender Variation in Chinese Courtroom
    Audio'' {[}\textbf{Revised \& Resubmitted}{]}
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
  ...
  \tightlist
  \item
    Hu, Yue, \textbf{Yuehong Cassandra Tai}, and Frederick Solt. ``Data
    Wrangling Before Harmonization: Best Practices for Getting Past the
    `Janitor Work.'\,'' {[}\textbf{Revised \& Resubmitted}{]}
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    Kim, Yooneui and \textbf{Yuehong Cassandra Tai}. ``The Skeptical
    Public: Trust in the United Nations''
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      ``Who Speaks, Who Falls Silent: Strategic Climate Messaging by
      State Legislators on Facebook and X'' (with Xun Cao, Yu-Ru Lin and
      Bruce A. Desmarais) {[}\textbf{Lead Author}{]}
    \end{enumerate}
  \item
    \begin{enumerate}
    \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  International World Wide Web Conference 2026 (WWW2026), Public Opinion
  Quarterly, Asian Survey, International Journal of Public Opinion
  Research, International Journal of Comparative Sociology.
\item
